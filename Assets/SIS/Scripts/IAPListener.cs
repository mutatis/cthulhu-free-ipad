    ...
    public class IAPListener : MonoBehaviour
    {
        ...
        public void HandleSuccessfulPurchase(string id)
        {
			...
			case "game3":
				...
				break;
			case "tripleCoins3":
				GameManager.gameManager.permanentTrippleCoin = true;
				PlayerPrefs.SetInt("PermanentTrippleCoin", 1);
				ShowMessage("You have unlock permanent triple coins!");
				break;
			case "doubleStars3":
				GameManager.gameManager.permanentDoubleCoin = true;
				PlayerPrefs.SetInt("PermanentDoubleCoin", 1);
				ShowMessage("You have unlock permanent double coins!");
				break;
			case "superStarPack3":
				DBManager.IncreaseFunds("coins", 1000000);
				//GameManager.gameManager.AddCoin(1000000);
				ShowMessage("200000 coins were added to your balance!");
				break;
			case "starPackGold3":
				DBManager.IncreaseFunds("coins", 200000);
				//GameManager.gameManager.AddCoin(200000);
				ShowMessage("100000 coins were added to your balance!");
				break;
			case "silverPack3":
				DBManager.IncreaseFunds("coins", 50000);
				//GameManager.gameManager.AddCoin(50000);
				ShowMessage("50000 coins were added to your balance!");
				break;
